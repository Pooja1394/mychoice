/*This file contains the code for User Profile Buy It Now Transaction Content 
Created By-Aviral Garg
Created On-18/04/18
*/
import React, { Component } from 'react'
import "../../style/userprofile/UserProfileBuyItNowTransaction.css"
export default class UserProfileBuyItNowTransaction extends Component {
    state = {
        arr:[
...
<div id="UserProfileBuyItNowTransactionTable">
<table>
 <tbody>
     <tr>
       ...
       <th id="ReceivedDateBox"scope="col">Received Date</th>
     ...
     <tr>
      <td id="SNoBox"></td>
       ...
       <td id="ReceivedDateBox" ><input className="filterField" type="text"/></td>
...
{ this.state.arr.map((item) => {
  ...
  <td id="ReceivedDateBox">{item.OrderDate}</td>
