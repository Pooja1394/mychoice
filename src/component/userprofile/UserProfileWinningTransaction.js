/*This file contains the code for User Profile Winning Transaction Content 
Created By-Aviral Garg
Created On-18/04/18
*/

import React, { Component } from 'react'
import "../../style/userprofile/UserProfileWinningTransaction.css"
export default class UserProfileWinningTransaction extends Component {
    state = {
        arr:[
...
<div id="UserProfileWinningTransactionTable">
<table>
 <tbody>
     <tr>
