...
render()
{
  ...
  if (this.props.state.data.data) {
    ...
    this.props.state.data.data.map((data, key) => {
      if(this.props.state.data.data[key].status=="Accept")
      {  
        ind++;
      let obj;
      obj = {
      ...
      <div>
        ...
        <div className="depositncredit-table-operations">
          ...
          <span id="selecNos">
            ...
            openNotificationWithIcon('success','Orders','Orders Assigned SuccessFully')
        ...
        loading={this.props.fetching}
          ...
          onSelectionChange={(e) => {
            ...
            console.log("orderAssigned",e.data)
          }}
        >
