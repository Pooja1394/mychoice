...
class PermissionsContent extends Component {
  constructor(){
    super();
    this.state={
      productName:"",
  ...
  componentWillMount() {
    ...
    this.props.onRequestExportCSV(this.dt,["52"])
  }
    ...
    return (
      <div>
        ...
        <div className="review-table-operations">
          ...
          <Link to="/home/review/createpermission">
            <button 
            style={{display:this.props.state  && checkAddPrivileges('Reviews')?'flex':'none'}}                                                                                                                                                                 
            id="btnAdd">Add Permission</button>
          </Link>
...
export default connect(  mapStateToProps,  mapDispatchToProps)(PermissionsContent);
