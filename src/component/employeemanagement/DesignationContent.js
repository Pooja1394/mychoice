...
import { GET_DESIGNATION_DATA_REQUEST, USER_TABLE_CSV, SET_PREVILIGES_IN_STORE_REQUEST } from "../../actions/types";

 class DesignationContent extends Component {
  state = {
    page: 1,
    limit: 10,
    fetching: false,
      ...
      <div>
        ...
        <div className="depositncredit-table-operations">
          ...
          <Link to="/home/employee/designation/adddesignation">
            ...
            id="btnAdd" style={{width:"120px"}}>Add Designation</button>
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DesignationContent);
