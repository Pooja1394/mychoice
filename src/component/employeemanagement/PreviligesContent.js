...
import { GET_PRIVILEGES_DATA_REQUEST, USER_TABLE_CSV } from "../../actions/types";

class PreviligesContent extends Component {
  state = {
    page: 1,
    limit: 10,
    fetching: false,
        ...
        <div className="depositncredit-table-operations">
          ...
          <Link to="/home/employee/previliges/addpreviliges">
           ...
           style={{display:this.props.state  && checkAddPrivileges('Employee')?'flex':'none'}}                                                                                                                                                                       
            id="btnAdd">Add Previliges</button>
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(PreviligesContent);