...
class Payment extends Component {
  ...
  componentWillMount() {
    ...
    this.props.getPaymentData({type:"payment"});
    this.props.onRequestExportCSV(this.dt,["62"])
  }
  onExport = () => {
    this.dt.exportCSV();
  };
  ...
  // tradecreatedAt = (rowData, column) => {
  //   return (
  //     <div>
  //       {DateFormat(rowData.tradecreatedAt)}&nbsp;&nbsp;{TimeFormat(
  //         rowData.tradecreatedAt
  //       )}
  //     </div>
  //   );
  // };
  ...
  clearAll=()=>{
    ...
    render() {
     ...
     onClick={this.handlePaid}>Paid</button>
