...
export default class CouponReports extends Component {
  ...
  componentWillMount() {
    ...
    render() {
        ...
        <Row>
            ...
            <Column header="Supplier Coupon" colSpan={3} />
            <Column header="Brand Coupon" colSpan={3} />
            <Column header="Product Coupon" colSpan={3} />
            <Column header="Profit/Loss" rowSpan={3} />
        </Row>
        <Row>
    ...
    //  disabled={this.state.paymentTradeOutList.length==0}
    //  style={{
    //   opacity:this.state.paymentTradeOutList.length==0?"0.5":"1",
    //   cursor:this.state.paymentTradeOutList.length==0?"not-allowed":"pointer",
    //   }}
